...
{
    private static readonly IReadOnlyList<GroupDefinition> GroupDefinitions = BuildGroupDefinitions();
    private static readonly IReadOnlyList<FixtureDefinition> GroupFixtures = BuildGroupFixtures();
    private static readonly IReadOnlyList<KnockoutTemplateDefinition> KnockoutTemplates = BuildKnockoutTemplates();
    private static readonly IReadOnlyDictionary<string, TeamStrengthDto> Strengths = BuildStrengths();
    ...
    private static IReadOnlyDictionary<string, TeamStrengthDto> BuildStrengths()
    {
        return new Dictionary<string, TeamStrengthDto>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Switzerland"] = new("Switzerland", 1900),
